<template>
  <div class="wrapper">
    ...
    <div class="miniPlayer" v-if="this.mini">
      ...
      <img :src="currentSongInfo.al.picUrl" @click="toFull" alt="" v-if="currentSongInfo.al" />
      <img :src="currentSongInfo.picUrl"  @click="toFull" alt="" v-if="currentSongInfo.picUrl" />
      <img :src="searchSong"  @click="toFull" alt="" v-if="currentSongInfo.album" />
